...
function Home() {
  ...
  const { products, setProducts, AddtoCart } = useContext(ProductsContext);
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 justify-center items-cente mx-auto bg-slate-100 pt-12">
      {loader ? (
        <div className=" flex justify-center items-center mx-auto w-[80vw] h-[70vh]">
          {" "}
          <PulseLoader className=" justify-center" color="#36d7b7" />
        </div>
      ) : (
